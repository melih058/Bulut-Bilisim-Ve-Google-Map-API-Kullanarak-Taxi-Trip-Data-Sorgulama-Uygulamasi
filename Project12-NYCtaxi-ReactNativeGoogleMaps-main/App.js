...
constructor(props) {
  ...
  componentDidMount(){
    ...
    destination1Change = e => {
      ...
      console.log("destination 1 değişti"+this.state.destination1.latitude+" longi"+this.state.destination1.longitude);
    }
...
var trip1originzone=Trips[Trips.length-2].data().DOLocationID;
var trip1destinationzone=Trips[Trips.length-2].data().PULocationID;
...
.then(querySnapshot => {
  querySnapshot.forEach(documentSnapshot => {
        if(documentSnapshot.data().LocationID==trip0originzone){
            ...
            console.log("İlk trip başlangıç Locationid:"+documentSnapshot.data().LocationID+" Zone: "+documentSnapshot.data().zone+" Latitude"+documentSnapshot.data().latitude+" Longitude"+documentSnapshot.data().longitude)
        ...
        if(documentSnapshot.data().LocationID==trip0destinationzone){
          ...
          console.log("İlk trip bitiş Locationid:"+documentSnapshot.data().LocationID+" Zone: "+documentSnapshot.data().zone+" Latitude"+documentSnapshot.data().latitude+" Longitude"+documentSnapshot.data().longitude)
      }
      if(documentSnapshot.data().LocationID==trip1originzone){
        ...
        console.log("İkinci trip başlangıç DOLocationid:"+documentSnapshot.data().LocationID+" Zone: "+documentSnapshot.data().zone+" Latitude"+documentSnapshot.data().latitude+" Longitude"+documentSnapshot.data().longitude)
    }
    if(documentSnapshot.data().LocationID==trip1destinationzone){
      ...
      console.log("İkinci trip bitiş PULocationid:"+documentSnapshot.data().LocationID+" Zone: "+documentSnapshot.data().zone+" Latitude"+documentSnapshot.data().latitude+" Longitude"+documentSnapshot.data().longitude)
  }
  }
  );
});
//this.prop
   async function changelocations(){
    ...
    console.log("Locations 2 :"+Locations[2]);
